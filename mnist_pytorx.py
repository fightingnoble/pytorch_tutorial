...
from model.torx.layer import crxb_Conv2d
from model.torx.layer import crxb_Linear
from model.torx.crossbarlayer import CrossbarLayer
...
# class Net(nn.Module):
#     def __init__(self, crxb_tech, crxb_size, scaler_dw, enable_SAF):
#         super(Net, self).__init__()
#         self.conv1 = crxb_Conv2d(1, 10, kernel_size=5, crxb=crxb_tech, crxb_size=crxb_size, scaler_dw=scaler_dw)
#         self.conv2 = crxb_Conv2d(10, 20, kernel_size=5, crxb=crxb_tech, crxb_size=crxb_size, scaler_dw=scaler_dw)
#         self.conv2_drop = nn.Dropout2d()
#         self.fc1 = crxb_Linear(320, 50, crxb=crxb_tech, crxb_size=crxb_size, scaler_dw=scaler_dw)
#         self.fc2 = crxb_Linear(50, 10, crxb=crxb_tech, crxb_size=crxb_size, scaler_dw=scaler_dw)

class Net(nn.Module):
    def __init__(self, scaler_dw, **kwargs):
        super(Net, self).__init__()
        ...
        self.conv1 = crxb_Conv2d(1, 10, kernel_size=5, scaler_dw=scaler_dw, **kwargs)
        self.conv2 = crxb_Conv2d(10, 20, kernel_size=5, scaler_dw=scaler_dw, **kwargs)
        self.conv2_drop = nn.Dropout2d()
        self.fc1 = crxb_Linear(320, 50, scaler_dw=scaler_dw, **kwargs)
        self.fc2 = crxb_Linear(50, 10, scaler_dw=scaler_dw, **kwargs)
...
def main():
    ...
    crxb_tech = CrossbarLayer(crxb_size=args.crxb_size, gmax=args.gmax, gmin=args.gmin, gwire=args.gwire,
                              gload=args.gload,
                              vdd=args.vdd, ir_drop=args.ir_drop, device=device, freq=args.freq, temp=args.temp,
    ...
    model = Net(scaler_dw=args.scaler_dw, **crxb_cfg).to(device)
    ...
    if not args.test:
        for epoch in range(args.epochs):
            ...
            filename = 'mnist_crxb_checkpoint_' + str(args.crxb_size) + '.pth.tar'
        ...
        modelfile = 'mnist_crxb_checkpoint_' + str(args.crxb_size) + '.pth.tar'
